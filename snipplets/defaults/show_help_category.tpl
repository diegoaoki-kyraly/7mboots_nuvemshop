                ...
                <div class="item span3">
                    <a href="/product/example" title="{{ product.name }}" class="item-link">
                        ...
                        <div class="item-info-container m-top-half m-bottom-half">
                            ...
                            <div class="item-price-container">
                                <span class="item-price weight-strong text-primary" id="price_display" itemprop="price" content="1000">{{"143000" | money }}</span>
                            </div>
                        </div>
                    </a>
                    <div class="text-uppercase font-small-extra m-top-quarter">
                ...
                <div class="item span3">
                    <a href="/product/example" title="{{ product.name }}" class="item-link">
                        ...
                        <div class="item-info-container m-top-half m-bottom-half">
                            ...
                            <div class="item-price-container">
                                <span class="item-price weight-strong text-primary" id="price_display" itemprop="price" content="1000">{{"110000" | money }}</span>
                            </div>
                        </div>
                    </a>
                    <div class="text-uppercase font-small-extra m-top-quarter">
